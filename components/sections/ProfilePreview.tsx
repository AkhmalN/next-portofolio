...
export const PopulatedSkill = [
  ...
  { name: "Vuejs", icon: <FaVuejs size={20} /> },
  { name: "Typescript", icon: <BiLogoTypescript size={20} /> },
...
export default function ProfilePreview() {
  ...
  useEffect(() => {
    ...
    console.log("profile preview mounted");
  }, []);

  return (
    <div className="w-56 min-h-screen  border-l border-muted/20 fixed top-0 left-0 h-screen z-50 overflow-y-auto scrollbar-hide">
      <div className="p-4 w-56">
        <div className="space-y-3">
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 py-2 border-y border-muted/20">
            <div className="text-center">
